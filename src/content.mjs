...
export const content = {
  de: {
    ...
    cookieConsent: { title: "Ihre Privatsphäre, klar geregelt.", text: "Wir verwenden eine notwendige Cookie-Einstellung, um Ihre Auswahl zu speichern. Analyse und Marketing sind derzeit nicht aktiv.", accept: "Alle akzeptieren", reject: "Ablehnen", manage: "Verwalten", save: "Auswahl speichern", close: "Schließen", necessary: "Notwendig", necessaryText: "Speichert Ihre Cookie-Auswahl und kann nicht deaktiviert werden.", analytics: "Analyse", analyticsText: "Derzeit ist kein Analysedienst verbunden.", marketing: "Marketing", marketingText: "Derzeit sind keine Marketing-Tracker verbunden.", always: "Immer aktiv", preferencesTitle: "Cookie-Einstellungen", preferencesText: "Sie können Ihre Auswahl jederzeit im Footer ändern." }
  },
  en: {
  ...
  es: {
    ...
    cookieConsent: { title: "Tu privacidad, sin letra pequeña.", text: "Usamos una cookie necesaria para recordar tu elección. La analítica y el marketing no están activos actualmente.", accept: "Aceptar todas", reject: "Rechazar", manage: "Gestionar", save: "Guardar selección", close: "Cerrar", necessary: "Necesarias", necessaryText: "Guarda tu elección de cookies y no se puede desactivar.", analytics: "Analítica", analyticsText: "Actualmente no hay ningún servicio de analítica conectado.", marketing: "Marketing", marketingText: "Actualmente no hay rastreadores de marketing conectados.", always: "Siempre activa", preferencesTitle: "Preferencias de cookies", preferencesText: "Puedes cambiar tu elección en cualquier momento desde el pie de página." }
  }
};
