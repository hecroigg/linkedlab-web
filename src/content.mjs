...
export const content = {
  de: {
    ...
    footer: { line: "Digital. Einfach. In Ihrer Hand.", area: "Für lokale Unternehmen in Mannheim, Ludwigshafen und Rhein-Neckar – und remote.", legal: "Impressum", privacy: "Datenschutz", rights: "Alle Rechte vorbehalten." },
    common: {
    ...
    projects: {
      ...
      items: [
        ...
        ["Lluna Blanca", "Website · Local SEO", "Digitaler Auftritt für ein Zentrum für Massagen, Naturtherapien und Ästhetik in Blanes. Fokus: klare Leistungen, lokales Vertrauen und direkter Kontakt.", "Live-Projekt"]
      ],
    ...
    contact: {
      ...
      response: "In der Regel erhalten Sie innerhalb von 1–2 Werktagen eine Antwort.",
      button: "Nachricht auf Instagram senden",
      finalNote: "Ein unverbindliches Erstgespräch ist kostenlos."
    },
    legal: { title: "Impressum", intro: "Die folgenden Angaben müssen vor Veröffentlichung mit den korrekten rechtlichen Daten vervollständigt und geprüft werden.", privacyTitle: "Datenschutzerklärung", privacyIntro: "Diese Seite ist als technische und inhaltliche Grundlage vorbereitet. Die markierten Angaben müssen vor Veröffentlichung mit den tatsächlich eingesetzten Diensten und den korrekten Unternehmensdaten abgeglichen werden." }
  },
  en: {
    ...
    footer: { line: "Digital, made simple.", area: "For local businesses in Mannheim, Ludwigshafen and Rhein-Neckar – and remotely.", legal: "Legal notice", privacy: "Privacy", rights: "All rights reserved." },
    ...
    ui: { noLockIn: "No lock-in", yours: "100% yours", fast: "Fast", local: "Local", system: ["Customers", "Appointments", "Business System", "Tasks", "Revenue"], mostChosen: "Most chosen", selectedProjects: "Selected projects", remote: "Remote", ownershipAssets: ["Domain", "Website", "Data", "Access"], projectTypes: ["Brand · Web · SEO", "Web · Local SEO"], connect: "Connect", navLabel: "Main navigation", languageLabel: "Language", openMenu: "Open menu", closeMenu: "Close menu", mobileNav: "Mobile navigation" },
    home: {
  ...
  es: {
    ...
    footer: { line: "Digital, sin complicaciones.", area: "Para negocios locales en Mannheim, Ludwigshafen y Rhein-Neckar, y también en remoto.", legal: "Aviso legal", privacy: "Privacidad", rights: "Todos los derechos reservados." },
    ...
    ui: { noLockIn: "Sin permanencia", yours: "Bajo tu control", fast: "Rápida", local: "Local", system: ["Clientes", "Citas", "Sistema", "Tareas", "Ingresos"], mostChosen: "Opción más elegida", selectedProjects: "Proyectos seleccionados", remote: "En remoto", ownershipAssets: ["Dominio", "Web", "Datos", "Accesos"], projectTypes: ["Marca · Web · SEO", "Web · SEO local"], connect: "Contacto", navLabel: "Navegación principal", languageLabel: "Idioma", openMenu: "Abrir menú", closeMenu: "Cerrar menú", mobileNav: "Navegación móvil" },
    home: {
    ...
    projects: { seoTitle: "Proyectos de diseño web | LinkedLab", seoDescription: "Proyectos seleccionados de LinkedLab: webs claras y sistemas digitales para negocios locales.", kicker: "Proyectos", title: "Pocos proyectos. Bien explicados.", intro: "Solo mostramos trabajos reales, sin métricas inventadas ni historias de éxito vacías.", items: [["LinkedLab", "Marca y web", "La propia web de LinkedLab muestra un posicionamiento claro, contenido en tres idiomas, precios transparentes y una arquitectura estática rápida.", "Proyecto actual"], ["Lluna Blanca", "Web · SEO local", "Presencia digital para un centro de masajes, terapias naturales y estética en Blanes. Con servicios claros, confianza local y contacto directo.", "Proyecto publicado"]], note: "Se añadirán más proyectos seleccionados cuando estén terminados y tengamos permiso para publicarlos.", finalTitle: "Tu negocio podría ser el próximo proyecto adecuado." },
    contact: { seoTitle: "Solicitar proyecto web | LinkedLab", seoDescription: "Habla con LinkedLab sobre una nueva web o un sistema digital. Primera valoración sin compromiso para pequeños negocios.", kicker: "Contacto", title: "Cuéntanos un poco sobre tu proyecto.", intro: "Basta con un mensaje corto. ¿A qué se dedica tu negocio, qué quieres mejorar y cuándo te gustaría empezar? Recibirás una respuesta honesta, sin presión comercial.", instagramTitle: "Escríbenos por Instagram", instagramText: "Para empezar de la forma más rápida, envía un mensaje directo a LinkedLab.", messageGuideTitle: "Información útil para incluir", messageGuide: ["Nombre y tipo de negocio", "Ubicación o zona objetivo", "¿Ya existe una web?", "¿Qué debería conseguir la nueva solución?", "Fecha aproximada"], response: "Normalmente respondemos en 1–2 días laborables.", button: "Enviar mensaje por Instagram", finalNote: "La primera conversación es gratuita y sin compromiso." },
    legal: { title: "Aviso legal", intro: "Los siguientes datos deben completarse con la información legal correcta y revisarse antes de publicar.", privacyTitle: "Política de privacidad", privacyIntro: "Esta página está preparada como base técnica y de contenido. Antes de publicar deben revisarse los datos marcados y adaptarse a los servicios realmente utilizados y a la información correcta del negocio." }
  }
};
